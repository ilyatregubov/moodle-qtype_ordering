 ...
 */
class num_parts_correct implements templatable, renderable {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        $a = new stdClass();
        list($a->numright, $a->numpartial, $a->numincorrect) = $this->questionattempt->get_question()->get_num_parts_right(
            $this->questionattempt->get_last_qt_data());
